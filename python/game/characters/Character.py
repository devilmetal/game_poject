...
class Character(pygame.sprite.Sprite):
    ...
    def calc_grav(self):
        ...
        self.rect.y += 4
        platform_hit_list = pygame.sprite.spritecollide(self, self.level.platform_list, False) + pygame.sprite.spritecollide(self, self.level.mov_plat_list, False) + pygame.sprite.spritecollide(self, self.level.sub_plat_list, False)
        self.rect.y -= 4
        ...
        if len(platform_hit_list) > 0 and self.rect.bottom < constants.SCREEN_HEIGHT - 20 and not self.hit:
            ...
            self.rect.y -= 2
            platform_top_list = pygame.sprite.spritecollide(self, self.level.platform_list, False) + pygame.sprite.spritecollide(self, self.level.mov_plat_list, False) + pygame.sprite.spritecollide(self, self.level.sub_plat_list, False)
            self.rect.y += 2

            if self.change_y < 0 and len(platform_top_list) > 0:
